...
parser.add_argument('-t','--threshold', metavar="THRESHOLD", default=220, help="grayscale-threshold to binarise image")
parser.add_argument('-g','--grayscale', help="converts image to grayscale", action="store_true")
parser.add_argument('-s','--size', metavar="OUTPUTWIDTH", default=2000, help="specify output-width of clean image")
...
#    a4_size = (a4_width,a4_width*sqrt2)
#    wa4,ha4 = a4_size
#
#
#    print(images_list)
